                ...
                <div class="portlet-body">
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="btn-group">
                                    <a href="{{ route('clients.create') }}" class="btn sbold green"> Add New Client
                    ...
                    <table class="table table-striped table-bordered table-hover" width="100%" id="sample_1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                        <a href="{{ route('clients.edit', $data->id) }}" class="btn btn-outline btn-circle green btn-sm purple">
                                        <i class="fa fa-edit"></i> Edit
                                    </a>
                                        <a href="javascript:void(0)" class="btn btn-outline btn-circle dark btn-sm black delete-data open-delete-modal" data-action="{{ route('clients.destroy', $data->id) }}" data-name="{{ $data->client_name }}">
