...
<div class="page-content">
    ...
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <span class="active">Material Edit Stuff</span>
        </li>
    </ul>
    <!-- END PAGE BREADCRUMB -->
    <div class="row">
            ...
            <div class="portlet light portlet-fit portlet-form bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-red sbold uppercase">Edit Material</span>
                    </div>
                    <div class="actions">
                ...
                <div class="portlet-body">
                    <!-- BEGIN FORM-->
                    <form action="{{ route('admin.materials.update', $item->id) }}" method="POST" id="form_sample_2" class="form-horizontal">
                        @csrf
                        @method('PUT')
                        <div class="form-body">
                                ...
                                <div class="col-md-4">
                                    <select id="property_module_id" name="property_module_id" class="form-control" required data-current-module="{{ $item->property_module_id ?? '' }}">
                                        ...
                                        @foreach($propertyModules as $module)
                                            <option value="{{ $module->id }}" {{ (isset($item) && $item->property_module_id == $module->id) ? 'selected' : '' }}>{{ $module->property_module_name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group @error('material_name') has-error @enderror">
                                <label class="control-label col-md-3">Material Name
                                    <span class="required"> * </span>
                                </label>
                                <div class="col-md-4">
                                    <input type="text" name="material_name" value="{{ $item->material_name ?? '' }}" class="form-control" required />
                                    @error('material_name')
                                        <span class="help-block"> {{ $message }} </span>
                                    @enderror
                                </div>
