...
<div class="page-content">
    ...
    <ul class="page-breadcrumb breadcrumb">
        ...
        <li>
            <span class="active">Property Module Stuff</span>
        </li>
    </ul>
    <!-- END PAGE BREADCRUMB -->
    <div class="row">
            ...
            <div class="portlet light portlet-fit portlet-form bordered">
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-red sbold uppercase">Add Property Module</span>
                    </div>
                    <div class="actions">
                ...
                <div class="portlet-body">
                    <!-- BEGIN FORM-->
                    <form action="{{ route('admin.property-modules.store') }}" method="POST" id="form_sample_2" class="form-horizontal">
                        @csrf
                        <div class="form-body">
                            ...
                            <div class="form-group @error('property_module_name') has-error @enderror">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="property_module_name" value="{{ old('property_module_name') }}" class="form-control" required />
